...
public class WinterOverlay implements IIngameOverlay {

    protected static final ResourceLocation FLOWER_LOCATION = new ResourceLocation(FarmingValleyMod.MOD_ID, "textures/gui/winter_overlay.png");
