...
public class CoinOverlay implements IIngameOverlay {

    protected static final ResourceLocation COIN_LOCATION = new ResourceLocation(FarmingValleyMod.MOD_ID, "textures/gui/coin_gui.png");
    ...
    public void render(ForgeIngameGui gui, PoseStack poseStack, float partialTick, int width, int height) {
        ...
        RenderSystem.setShaderTexture(0, COIN_LOCATION);
        GuiUtils.drawTexturedModalRect(poseStack, width-90, 10, 0, 0, 256, 256, 0);
